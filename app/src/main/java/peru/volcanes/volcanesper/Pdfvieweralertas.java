...
public class Pdfvieweralertas extends FragmentActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blocke1a.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(Pdfvieweralertas.this,pagedivisor.class);
        ...
        blocke2a.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Pdfvieweralertas.this,Informacion.class);
                startActivity(intent);
            }
        });
        blocke4a.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Pdfvieweralertas.this,Configuraciones.class);
                startActivity(intent);
            }
        });
        blocke5a.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Pdfvieweralertas.this,Convenciones.class);
                startActivity(intent);
            }
        });
        ...
        blocke9.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Pdfvieweralertas.this,Listadoredessociales.class);
                startActivity(intent);
            }
        });
...
*/
    ...
    private void openDetailActivity(String...details) {
        Intent i=new Intent(Pdfvieweralertas.this,Dispersioncenizas.class);
        ...
        Pdfvieweralertas.this.startActivity(i);
    }

    private void openmap(String...details)
    {
        Intent i=new Intent(Pdfvieweralertas.this,Sismosengeneral.class);
        i.putExtra("ACTIVIDAD_RECIENTE",details[0]);
        i.putExtra("ESTADO",details[1]);
        i.putExtra("NOMBRES",details[2]);
        i.putExtra("UBICACION",details[3]);
    ...
    {
        Intent i=new Intent(Pdfvieweralertas.this,sismosengeneralgoogle.class);
        i.putExtra("ACTIVIDAD_RECIENTE",details[0]);
        i.putExtra("ESTADO",details[1]);
        i.putExtra("NOMBRES",details[2]);
        i.putExtra("UBICACION",details[3]);
    ...
    private void alerta_cenizas(String...details) {
        Intent i=new Intent(Pdfvieweralertas.this,Reportesalertascenizastwo.class);
        i.putExtra("ACTIVIDAD_RECIENTE",details[0]);
        i.putExtra("ESTADO",details[1]);
        i.putExtra("NOMBRES",details[2]);
        i.putExtra("UBICACION",details[3]);
    ...
    private void camara_web(String...details) {
        Intent i=new Intent(Pdfvieweralertas.this,Volcancamara.class);
        i.putExtra("ACTIVIDAD_RECIENTE",details[0]);
        i.putExtra("ESTADO",details[1]);
        i.putExtra("NOMBRES",details[2]);
        i.putExtra("UBICACION",details[3]);
    ...
    private void sismograma_web(String...details) {
        Intent i=new Intent(Pdfvieweralertas.this,Sismogramas.class);
        i.putExtra("ACTIVIDAD_RECIENTE",details[0]);
        i.putExtra("ESTADO",details[1]);
        i.putExtra("NOMBRES",details[2]);
        i.putExtra("UBICACION",details[3]);
    ...
    private void reportes(String...details) {
        Intent i=new Intent(Pdfvieweralertas.this,Reportesdeactividad.class);
        i.putExtra("ACTIVIDAD_RECIENTE",details[0]);
        i.putExtra("ESTADO",details[1]);
        i.putExtra("NOMBRES",details[2]);
        i.putExtra("UBICACION",details[3]);
