...
public class Convenciones extends FragmentActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        mimageView5.setImageResource(R.drawable.estratovolcan);
        mimageView6.setImageResource(R.drawable.caldera);
        mimageView7.setImageResource(R.drawable.domodelava);
        mimageView8.setImageResource(R.drawable.fisuras);
        mimageView9.setImageResource(R.drawable.hawaiano);
        mimageView10.setImageResource(R.drawable.estromboliano);
        mimageView11.setImageResource(R.drawable.vulcaniano);
        mimageView12.setImageResource(R.drawable.subpliniano);
        mimageView13.setImageResource(R.drawable.pliniano);
        mimageView14.setImageResource(R.drawable.ultrapliniano);
        mimageView15.setImageResource(R.drawable.monitoreosismico);
        mimageView16.setImageResource(R.drawable.deformacion);
        mimageView17.setImageResource(R.drawable.geoquimico);
        mimageView18.setImageResource(R.drawable.monitoreovisual);
        mimageView19.setImageResource(R.drawable.iindice_explosividad);
        mimageView20.setImageResource(R.drawable.pronosticodispersion);
        mimageView21.setImageResource(R.drawable.mapasismico3d);
        mimageView22.setImageResource(R.drawable.glaciar);
        ...
        mimageView25.setImageResource(R.drawable.hibrido);
        mimageView26.setImageResource(R.drawable.explosion);
        mimageView27.setImageResource(R.drawable.largoperiodo);
        mimageView28.setImageResource(R.drawable.altafrecuencia);
        mimageView29.setImageResource(R.drawable.monitoreoelectrico);
